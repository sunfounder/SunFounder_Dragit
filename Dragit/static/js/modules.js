...
SpriteMorph.prototype.loadModulesCategories = function(blocks, block, watcherToggle){
    ...
    blocks.push(block('i2c_lcd1602_clear'));
    blocks.push(block('i2c_lcd1602_print'));
    blocks.push('-');
...
SpriteMorph.prototype.blocks.i2c_lcd1602_clear = {
    type    : 'command',
    category: 'Modules',
    spec    : 'i2c lcd1602 clear',
  }

SpriteMorph.prototype.blocks.i2c_lcd1602_print = {
    type    : 'command',
    category: 'Modules',
...
SpriteMorph.prototype.blockAlternatives.i2c_lcd1602_print = ['i2c_lcd1602_clear','i2c_lcd2004_clear','i2c_lcd2004_print'];
SpriteMorph.prototype.blockAlternatives.i2c_lcd1602_clear = ['i2c_lcd1602_print','i2c_lcd2004_print','i2c_lcd2004_clear'];
SpriteMorph.prototype.blockAlternatives.i2c_lcd2004_print = ['i2c_lcd2004_clear','i2c_lcd1602_clear','i2c_lcd1602_print'];
SpriteMorph.prototype.blockAlternatives.i2c_lcd2004_clear = ['i2c_lcd2004_print','i2c_lcd1602_clear','i2c_lcd1602_print'];
...
SpriteMorph.prototype.i2c_lcd1602_clear = function () {
  return requests('modules', 'i2c_lcd1602_clear')
};

SpriteMorph.prototype.i2c_lcd1602_print = function (pos_col, pos_row, words) {
  return requests('modules', 'i2c_lcd1602_print', pos_col, pos_row, words)
};
